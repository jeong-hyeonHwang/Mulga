...
public class MessageHelperService {
    public static String makeCardPrompt(List<FinanceNotiDto> notiList) {
        ...
        // 프롬프트 마지막에 요청 사항 추가
        sb.append("위의 거래 내역을 하나의 거래 내역으로 합쳐주세요.\n");
        sb.append("paymentMethod에는 'OO카드' 또는 'OOcard' 의 내용을 넣어주세요.\n");
        sb.append("itemName은 빈 문자열이 아니어야 합니다.\n");
