...
@Composable
fun TransactionCombineDetailHeaderView(
    category: Category,
    cost: Int,
    onEditClick: () -> Unit,
    ...
    Column(
        ...
        Row(
            ...
            CombineNoticeButton(combineNum = combineNum, onClick = onCombineClick)
        }
...
@Preview
@Composable
fun TransactionCombineDetailHeaderViewPreview() {
    TransactionCombineDetailHeaderView(
